...
// Elimina caracter '\n' situado al final de una cadena
...
// Buscar pila asociada un objeto libro
...
// Formar cadena con las palabras y posiciones (guardadas en una pila) de un libro
...
// Contar cuantos documentos poseen la misma palabra para el coalculo de relevancia
...
// Funcion 7 (para partir con la funcion 7 debes de completar la funcion 5 :D)